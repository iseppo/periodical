...
# this if clause doesn't seem to work as the max data is always from previous days I guess
  ...
  # katkesta tervet raportit. colClasses on tahtlikult ära jäetud — positsiooni-
  # line tüübimääramine läheb katki niipea, kui allikas veerge lisandub/kaob.
