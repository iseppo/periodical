...
fondid_info <- full_join(fondid_maht, fondid_investorid) %>%
  ...
  mutate(Lühinimi = case_when(
    ...
    Lühinimi == "LRK100" ~ "LHV Rohel",
    Lühinimi == "NIK100" ~ "Lum Indeks",
    Lühinimi == "SIK75" ~ "SEB Indeks",
    Lühinimi == "SWK100" ~ "SW Indeks",
    Lühinimi == "SWK99" ~ "SW Ind 90s",
    # LHV fondid
    Lühinimi == "LLK50" ~ "LHV L",
    Lühinimi == "LMK25" ~ "LHV M",
    Lühinimi == "LSK00" ~ "LHV S",
    Lühinimi == "LXK75" ~ "LHV XL",
    Lühinimi == "LXK00" ~ "LHV XS",
    # Luminor fondid
