...
if(nrow(fondid_turuosa) > 0) {
  ...
  # Võtame TOP 10 fondi KONTODE ARVU järgi (ainult need, millel on andmed)
  ...
  colors_kontod <- c("#e60049", "#50e991", "#e6d800", "#9b19f5", "#ffa300",
                     "#dc0ab4", "#b3d4ff", "#00bfa0", "#ff6e54", "#444e86")[1:top_arv_k]
  ...
  p <- top_kontod %>%
    ...
    labs(x = "", y = "osakuomanike arv",
         title = paste0("TOP 10 fondi kontode arvu järgi (", maksp2ev, ")")) +
...
if(nrow(fondid_turuosa) > 0) {
  ...
  # Võtame TOP 10 fondi TURUOSA järgi
  ...
  colors_turuosa <- c("#e60049", "#50e991", "#e6d800", "#9b19f5", "#ffa300",
                      "#dc0ab4", "#b3d4ff", "#00bfa0", "#ff6e54", "#444e86")[1:top_arv_t]
  ...
  p <- top_turuosa %>%
    ...
    labs(x = "", y = "turuosa (%)",
         title = paste0("TOP 10 fondi turuosa järgi (", maksp2ev, ")")) +
    theme(axis.text.x = element_text(angle = 45, hjust = 1),
          legend.position = "none")
  ggplotly(p)
} else {
